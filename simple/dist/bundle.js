...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      todos: _immutable2.default.fromJS([])
	    };
	  },
	  addTodo: function addTodo(text) {
	    console.log(text);
	    var todos = this.state.todos;
	    var id = todos.reduce(function (maxId, todo) {
	      return Math.max(maxId, todo.get('id'));
	    }, -1) + 1;
	    todos = todos.push(_immutable2.default.fromJS({
	      text: text,
	      id: id,
	      completed: false
	    }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoTextInput = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoFilters = __webpack_require__(169);
