...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dispatcher = __webpack_require__(172);
	...
	var App = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(_app2.default, {
	      count: _store2.default.get().count,
	      todos: _store2.default.get().todos,
	      addTodo: createActionDispatch(_actions.addTodo),
	      clearCompleted: createActionDispatch(_actions.clearCompleted),
	      completeAll: createActionDispatch(_actions.completeAll),
	      completeTodo: createActionDispatch(_actions.completeTodo),
	      deleteTodo: createActionDispatch(_actions.deleteTodo),
	      editTodo: createActionDispatch(_actions.editTodo)
	    });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainSection = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoItem = __webpack_require__(165);
	...
	var _TodoFilters = __webpack_require__(167);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        filteredTodos.map(function (todo) {
	          return _react2.default.createElement(_TodoItem2.default, { key: todo.id, todo: todo, completeTodo: completeTodo, deleteTodo: deleteTodo, editTodo: editTodo });
	        })
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(169);

	var _reducer2 = _interopRequireDefault(_reducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _reducer2.default)(undefined, {});
	var listeners = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		return {
			...
			log: (0, _todos2.default)(state.log, action)
		};
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dispatch(action) {
		if ((typeof action === 'undefined' ? 'undefined' : _typeof(action)) == 'object') {
			var oldStore = _store2.default.get();
			var newStore = (0, _reducer2.default)(oldStore, action);
			_store2.default.set(newStore);
		} else {
			action(dispatch);
		}
	}
