...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindData = __webpack_require__(172);

	var _bindData2 = _interopRequireDefault(_bindData);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	  displayName: 'App',
	  onDataChange: function onDataChange(prefix, operation, key, value) {
	    key = [prefix].concat(_toConsumableArray(key));
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_Header2.default, { onDataChange: this.onDataChange.bind(this, 'todos') }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoTextInput = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoItem = __webpack_require__(169);
	...
	var _TodoFilters = __webpack_require__(171);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        filteredTodos.map(function (todo, index) {
	          return _react2.default.createElement(_TodoItem2.default, { key: todo.get('id'), todo: todo, completeTodo: completeTodo.bind(null, index), onDataChange: _this.onDataChange.bind(null, index) });
	        })
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BindData = {
		getInitialState: function getInitialState() {
			return {
				data: _immutable2.default.fromJS({
					count: 0,
					todos: []
				})
			};
		},
		onDataChange: function onDataChange(operation, key, value) {
			console.log(operation + "," + key + "," + value);
			value = _immutable2.default.fromJS(value);
